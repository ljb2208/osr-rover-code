...
class Roboclaw
{
	public:
		...
		bool SpeedAccelM1(uint8_t address, int32_t accel, int32_t speed);
		bool SpeedAccelM2(uint8_t address, int32_t accel, int32_t speed);
		bool SpeedAccelM1M2(uint8_t address, int32_t accel, int32_t speed1, int32_t speed2);
		...
		bool SpeedAccelDistanceM1(uint8_t address, int32_t accel, int32_t speed, int32_t distance, uint8_t flag=0);
		bool SpeedAccelDistanceM2(uint8_t address, int32_t accel, int32_t speed, int32_t distance, uint8_t flag=0);
		bool SpeedAccelDistanceM1M2(uint8_t address, int32_t accel, int32_t speed1, int32_t distance1, int32_t speed2, int32_t distance2, uint8_t flag=0);
		...
		bool SpeedAccelDeccelPositionM1(uint8_t address,int32_t accel,int32_t speed,int32_t deccel,int32_t position,uint8_t flag);
		bool SpeedAccelDeccelPositionM2(uint8_t address,int32_t accel,int32_t speed,int32_t deccel,int32_t position,uint8_t flag);
		bool SpeedAccelDeccelPositionM1M2(uint8_t address,int32_t accel1,int32_t speed1,int32_t deccel1,int32_t position1,int32_t accel2,int32_t speed2,int32_t deccel2,int32_t position2,uint8_t flag);
