...
#define SetSignedDWORDval(arg) (uint8_t)(((int32_t)arg)>>24),(uint8_t)(((int32_t)arg)>>16),(uint8_t)(((int32_t)arg)>>8),(uint8_t)arg
...
bool Roboclaw::SpeedAccelM1(uint8_t address, int32_t accel, int32_t speed){
    return write_n(10,address,M1SPEEDACCEL,SetSignedDWORDval(accel),SetSignedDWORDval(speed));
}

bool Roboclaw::SpeedAccelM2(uint8_t address, int32_t accel, int32_t speed){
    return write_n(10,address,M2SPEEDACCEL,SetSignedDWORDval(accel),SetSignedDWORDval(speed));
}
bool Roboclaw::SpeedAccelM1M2(uint8_t address, int32_t accel, int32_t speed1, int32_t speed2){
    return write_n(14,address,MIXEDSPEEDACCEL,SetSignedDWORDval(accel),SetSignedDWORDval(speed1),SetSignedDWORDval(speed2));
}
...
bool Roboclaw::SpeedAccelDistanceM1(uint8_t address, int32_t accel, int32_t speed, int32_t distance, uint8_t flag){
    return write_n(15,address,M1SPEEDACCELDIST,SetSignedDWORDval(accel),SetSignedDWORDval(speed),SetSignedDWORDval(distance),flag);
}

bool Roboclaw::SpeedAccelDistanceM2(uint8_t address, int32_t accel, int32_t speed, int32_t distance, uint8_t flag){
    return write_n(15,address,M2SPEEDACCELDIST,SetSignedDWORDval(accel),SetSignedDWORDval(speed),SetSignedDWORDval(distance),flag);
}

bool Roboclaw::SpeedAccelDistanceM1M2(uint8_t address, int32_t accel, int32_t speed1, int32_t distance1, int32_t speed2, int32_t distance2, uint8_t flag){
    return write_n(23,address,MIXEDSPEEDACCELDIST,SetSignedDWORDval(accel),SetSignedDWORDval(speed1),SetSignedDWORDval(distance1),SetSignedDWORDval(speed2),SetSignedDWORDval(distance2),flag);
}
...
bool Roboclaw::SpeedAccelDeccelPositionM1(uint8_t address,int32_t accel,int32_t speed,int32_t deccel,int32_t position,uint8_t flag){
    return write_n(19,address,M1SPEEDACCELDECCELPOS,SetSignedDWORDval(accel),SetSignedDWORDval(speed),SetSignedDWORDval(deccel),SetSignedDWORDval(position),flag);
}

bool Roboclaw::SpeedAccelDeccelPositionM2(uint8_t address,int32_t accel,int32_t speed,int32_t deccel,int32_t position,uint8_t flag){
    return write_n(19,address,M2SPEEDACCELDECCELPOS,SetSignedDWORDval(accel),SetSignedDWORDval(speed),SetSignedDWORDval(deccel),SetSignedDWORDval(position),flag);
}

bool Roboclaw::SpeedAccelDeccelPositionM1M2(uint8_t address,int32_t accel1,int32_t speed1,int32_t deccel1,int32_t position1,int32_t accel2,int32_t speed2,int32_t deccel2,int32_t position2,uint8_t flag){
    return write_n(35,address,MIXEDSPEEDACCELDECCELPOS,SetSignedDWORDval(accel1),SetSignedDWORDval(speed1),SetSignedDWORDval(deccel1),SetSignedDWORDval(position1),SetSignedDWORDval(accel2),SetSignedDWORDval(speed2),SetSignedDWORDval(deccel2),SetSignedDWORDval(position2),flag);
}
